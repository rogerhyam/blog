...
\[embed\]http://hyam.net/mp3/four\_nutriments\_sharing.mp3\[/embed\]

 

Thich Nhat Hanh Audio has [a whole section on talks where Thay has mentioned the Four Nutriments](https://tnhaudio.org/tag/four-kinds-of-nutriments/) so if you want a real Dharma talk please head over there.
