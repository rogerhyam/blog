---
title: "Calling Time on Biological Nomenclature"
date: 2009-08-04
categories: 
  - "biodiv"
---
...
Although continuously updated the codes are still focused on a world of paper publication with a relatively small number of journals in each specialist field. The codes are run on the basis of consensus building and, because the need for registration is not yet universally recognised, no such registers have been established. [ICZN](http://www.iczn.org/) is in the process of attempting to establish one in the form of [ZooBank](http://www.zoobank.org/). A register for ICBN was proposed, then they fumbled and dropped the ball but may pick it up at some point in the future.
...
\* Before you have a knee jerk reaction to the thought of barcodes defining taxa rather than merely labelling them you might read [Identifiers, Indentity and Me](http://www.hyam.net/blog/archives/304) where I rather unskillfully advocate that an identifier erects a thing rather than things having identifiers. All we have to do is say "Anything that has this barcode is this thing"
